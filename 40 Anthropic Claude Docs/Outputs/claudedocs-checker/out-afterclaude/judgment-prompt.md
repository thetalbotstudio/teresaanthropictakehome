...
Most servers that use bearer tokens reject the second form. The same applies to Basic authentication: enter `Basic ` followed by the base64-encoded credentials.
